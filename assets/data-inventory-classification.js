(function (root, factory) {
  ...
  const DATA_INVENTORY = Object.freeze([
    ...
    entry('organization_tenant_metadata', 'Organization tenant memberships and partition keys', 'sensitive_personal', 'organization tenant domain', ['tenant records', 'membership records', 'data partition keys', 'tenant audit scopes'], 'school_data_owner', ['parent_guardian', 'teacher', 'system_admin', 'automation'], 'exportable as tenant and membership metadata without learner content', 'revoked archived or deleted through tenant lifecycle owner approval', 'eligible only as aggregate tenant setup and isolation evidence', 'future backend provider stores partition keys and membership metadata without provider payloads', ['docs/organization-tenancy.md', 'tests/organization-tenant-domain.test.js']),
    ...
    entry('institutional_report_projection', 'Institutional classroom reporting projections', 'educational_record', 'institutional reporting domain', ['tenant report projections', 'class skill summaries', 'standards coverage summaries', 'intervention queues'], 'school_data_owner', ['teacher', 'system_admin', 'automation'], 'exportable only as suppressed or redacted aggregate report metadata', 'deleted or regenerated with verified evidence retention and tenant lifecycle rules', 'eligible only as small-cohort-safe aggregate reporting evidence', 'future backend provider stores aggregate projections without learner drilldown payloads', ['docs/institutional-reporting-projections.md', 'tests/institutional-reporting-domain.test.js']),
    entry('institutional_export_manifest', 'Institutional export manifests and approvals', 'operational', 'institutional data export policy', ['export request records', 'approval records', 'export manifests', 'audit review records'], 'security_owner', ['system_admin', 'automation'], 'exportable as manifest and approval evidence without export payload bodies', 'append-only until audit retention expires and security owner approves pruning', 'eligible only as aggregate compliance workflow counts', 'future backend provider stores manifest metadata without downloadable files or provider payloads', ['docs/institutional-data-export-and-audit.md', 'tests/institutional-data-export-policy.test.js']),
