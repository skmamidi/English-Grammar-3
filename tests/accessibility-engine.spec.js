...
const APP_PAGES = [
  ...
  { label: 'Subtopic lesson start', file: 'topics/grammar/subtopics/sentence-types.html', waitFor: '[data-story-lesson="grammar-sentence-types"]' },
  { label: 'Active question', file: 'topics/grammar/subtopics/sentence-types.html?practice=1', state: startQuiz },
  { label: 'Question feedback', file: 'topics/grammar/subtopics/sentence-types.html?practice=1', state: answerQuestion },
  { label: 'Quiz results', file: 'topics/capitalization/subtopics/books-magazines-songs-plays.html?practice=1', state: finishQuiz },
