(function (root, factory) {
  ...
  const DEFAULT_COMPLIANCE_RELEASE_CHECKLIST = Object.freeze({
    items: Object.freeze([
      ...
      item('billing_prerequisites', 'billing_policy_owner', 'node --test tests/commerce-readiness-policy.test.js tests/subscription-ux-policy.test.js tests/transactional-communication-contract.test.js tests/commerce-security-policy.test.js tests/commerce-support-policy.test.js tests/billing-provider-capability-matrix.test.js tests/billing-domain-contracts.test.js tests/payment-provider-adapter-boundary.test.js tests/checkout-method-policy.test.js tests/billing-webhook-ledger-policy.test.js tests/billing-entitlement-projection.test.js tests/fake-provider-billing-fixtures.test.js tests/data-inventory-classification.test.js tests/privacy-docs.test.js tests/policy-aware-feature-flags.test.js', 'critical', ['production', 'billing-preview'], 'billing-affecting releases', ['docs/commerce-readiness-launch-gate.md', 'docs/subscription-ux-standards.md', 'docs/transactional-communications.md', 'docs/security/commerce-security-policy.md', 'docs/checkout-method-policy.md', 'docs/commerce-support-policy.md', 'docs/billing-provider-capability-matrix.json', 'docs/billing-domain-contracts.md', 'docs/security/payment-provider-adapter-boundary.md', 'docs/billing-webhook-ledger-policy.md', 'docs/billing-entitlement-projection.md', 'docs/fake-provider-billing-fixtures.md', 'docs/security/records-of-processing.md', 'docs/security/data-inventory.md', 'docs/feature-flags.md'])
    ])
  });
