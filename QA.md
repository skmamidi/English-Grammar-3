...
- App shell budgets are documented in `docs/performance/app-shell-budgets.md`. Use `npm run qa:app-shell` to measure HTML, CSS, JavaScript, service worker, release metadata, and static asset bytes separately from question chunks and preloaded question payloads.
