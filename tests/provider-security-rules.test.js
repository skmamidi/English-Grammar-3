...
test('firestore rule scenarios cover provider-neutral backend policy boundaries', () => {
  ...
  assert.ok(ids.includes('allow-student-learning-attempt-create'));
  assert.ok(ids.includes('deny-student-xp-projection-write'));
  assert.ok(ids.includes('deny-student-learning-projection-write'));
  ...
  assert.ok(ids.includes('allow-server-verified-learning-attempt-create'));
  assert.ok(ids.includes('deny-server-verified-learning-attempt-update'));
  assert.ok(ids.includes('allow-server-learning-projection-write'));
  assert.ok(ids.includes('allow-server-institutional-learning-report-write'));
  assert.ok(ids.includes('allow-tenant-teacher-learner-read'));
  assert.ok(ids.includes('deny-cross-tenant-teacher-learner-read'));
  assert.ok(ids.includes('allow-tenant-server-verified-learning-attempt-create'));
  assert.ok(ids.includes('deny-cross-tenant-server-verified-learning-attempt-create'));
