(function (root, factory) {
  ...
  const DEFAULT_COMPLIANCE_RELEASE_CHECKLIST = Object.freeze({
    items: Object.freeze([
      ...
      item('institutional_rollout', 'operations_owner', 'node --test tests/institutional-rollout-gates.test.js tests/institutional-provisioning-slo-policy.test.js tests/production-slo-policy.test.js tests/synthetic-monitor-policy.test.js', 'critical', ['staging', 'production'], 'institutional releases', ['docs/institutional-rollout-and-provisioning.md', 'docs/operations/production-slos.md', 'docs/operations/synthetic-monitors.md', 'tests/institutional-rollout-gates.test.js', 'tests/institutional-provisioning-slo-policy.test.js']),
