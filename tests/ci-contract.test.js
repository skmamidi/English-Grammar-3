...
test('package scripts expose reproducible browser install and full QA gate', () => {
  ...
  assert.equal(pkg.scripts['test:offline'], 'node tests/offline-smoke.spec.js && node tests/sparse-offline-smoke.spec.js');
  ...
  assert.match(pkg.scripts['test:unit'], /tests\/guided-mission-domain\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/guided-mission-generation\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/guided-mission-qa\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/guided-mission-ui\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/mission-recommendation-domain\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/mission-progress-domain\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/mission-reward-policy\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/mission-dashboard-domain\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/mission-reminder-policy\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/mission-telemetry-policy\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/mission-rollout-gates\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/content-repository-contract\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/sparse-question-delivery-contract\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/learning-attempt-service\.test\.js/);
  assert.match(pkg.scripts['test:unit'], /tests\/learning-projection-service\.test\.js/);
  ...
  assert.match(pkg.scripts['test:unit'], /tests\/native-receipt-validation\.test\.js/);
  ...
  assert.match(pkg.scripts['test:unit'], /tests\/provider-webhook-signature\.test\.js/);
  ...
  assert.match(pkg.scripts['test:unit'], /tests\/question-media-preload-policy\.test\.js/);
  ...
  assert.match(pkg.scripts['test:unit'], /tests\/personalization-rollout-gates\.test\.js/);
